...
class PostsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreatePost = channel.unary_unary(
                ...
                response_deserializer=proto_dot_posts__pb2.PostResponse.FromString,
        ...
        self.ListPosts = channel.unary_unary(
                ...
                request_serializer=proto_dot_posts__pb2.ListPostsRequest.SerializeToString,
                response_deserializer=proto_dot_posts__pb2.ListPostsResponse.FromString,
                _registered_method=True)
...
def add_PostsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreatePost': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=proto_dot_posts__pb2.PostResponse.SerializeToString,
            ),
            ...
            'ListPosts': grpc.unary_unary_rpc_method_handler(
                    servicer.ListPosts,
                    request_deserializer=proto_dot_posts__pb2.ListPostsRequest.FromString,
                    response_serializer=proto_dot_posts__pb2.ListPostsResponse.SerializeToString,
            ),
    }
...
class PostsService(object):
    ...
    def CreatePost(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            proto_dot_posts__pb2.PostResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ListPosts(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/posts.PostsService/ListPosts',
            proto_dot_posts__pb2.ListPostsRequest.SerializeToString,
            proto_dot_posts__pb2.ListPostsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
